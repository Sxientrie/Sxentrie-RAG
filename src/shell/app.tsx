...
// Actions are simplified as much of the state is now in domain contexts
type AppAction =
...
const getInitialState = (): AppState => {
    try {
        ...
        // Cannot delete, so we just reset to default
...
// The main three-panel UI is now its own component
const MainLayout: FC = () => {
